...
# Créer des docteurs (doctors) avec des spécialités
doctor1 = Doctor.create(first_name: "John", last_name: "Doe", zip_code: "12345", city: city1)
doctor1.specialties << specialty1

doctor2 = Doctor.create(first_name: "Alice", last_name: "Johnson", zip_code: "67890", city: city2)
